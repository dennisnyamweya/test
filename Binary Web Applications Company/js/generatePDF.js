...
function generatePDF() {
  ...
  // More Information
  doc.setFontSize(13);
  var totalTitle = 'binarywebapplications@gmail.com';
  ...
  doc.text('www.binarywebapplications.com', pageCenter, 289, 'center');

  // Save the file
  doc.save('project-estimate-by-BinaryWebApplications.pdf');
}